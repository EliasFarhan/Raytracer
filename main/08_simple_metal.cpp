...
int main() {
    ...
    constexpr int samplePerPixel = 32;
    // World
    ...
    world.Add({ ray::Vec3f(-1,0,-1), 0.5f }, std::make_unique<ray::Metallic>(ray::Vec3f(0.8f, 0.8f, 0.8f)));
    world.Add({ ray::Vec3f(1,0,-1), 0.5f }, std::make_unique<ray::Metallic>(ray::Vec3f(0.8f,0.6f, 0.2f)));
    // Render
