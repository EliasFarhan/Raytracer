...
int main() {
    ...
    // Camera
    const ray::Camera camera(ray::Vec3f(-2,2,1), ray::Vec3f(0,0,-1),ray::Vec3f(0,1,0),90.0f,aspect_ratio);
    ...
    world.Add({ ray::Vec3f(0,0,-1), 0.5f }, std::make_unique<ray::Lambertian>(ray::Vec3f(0.1f,0.2f, 0.5f)));
    world.Add({ ray::Vec3f(1,0,-1), 0.5f }, std::make_unique<ray::Metallic>(ray::Vec3f(0.8f, 0.6f, 0.2f), 0.0f));
    world.Add({ ray::Vec3f(-1,0,-1), 0.5f }, std::make_unique<ray::Dielectric>(1.5f));
    world.Add({ ray::Vec3f(-1,0,-1), -0.45f }, std::make_unique<ray::Dielectric>(1.5f));
    // Render
